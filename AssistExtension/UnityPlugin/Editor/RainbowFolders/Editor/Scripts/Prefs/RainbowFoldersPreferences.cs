...
namespace Borodar.RainbowFolders.Editor
{
    public class RainbowFoldersPreferences
    {
        ...
        private static string _AiukLocation;
        private static string _Home_Folder_Default;

        private static string HOME_FOLDER_DEFAULT
        {
            get
            {
                _AiukLocation = EditorPrefs.GetString("AiukLocation", "Aiuk.UnityKit");

                _Home_Folder_Default = "Assets/" + _AiukLocation + "/AssistExtension/UnityPlugin/Editor/RainbowFolders";
                return _Home_Folder_Default;
            }
        }

        private const string HOME_FOLDER_HINT =
        ...
        private const string MOD_KEY_HINT =
            "Modifier key that is used to show configuration dialogue when clicking on a folder icon.";
        ...
        static RainbowFoldersPreferences()
        {
            ...
            EditorPrefs.SetString(HOME_FOLDER_PREF_KEY + ProjectName, HOME_FOLDER_DEFAULT);
            HOME_FOLDER_PREF =
                new EditorPrefsString(HOME_FOLDER_PREF_KEY + ProjectName, homeLabel, HOME_FOLDER_DEFAULT);
            HomeFolder = HOME_FOLDER_PREF.Value;

            var modifierLabel = new GUIContent("Modifier Key", MOD_KEY_HINT);
            MODIFIER_KEY_PREF =
                new EditorPrefsModifierKey(MOD_KEY_PREF_KEY + ProjectName, modifierLabel, MOD_KEY_DEFAULT);
