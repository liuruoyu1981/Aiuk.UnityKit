...
// Author:        liuruoyu1981
// CreateDate:    3/7/2018 9:34:04 AM
...
namespace AiukUnityRuntime
{
    ...
    /// 可被观察的Int数据。
    /// </summary>
    public class AiukReactInt : IAiukReactData<int>
    {
        ...
        /// 数据变化处理委托列表。
        /// </summary>
        private readonly List<Action<int>> m_DataChangeActions
        = new List<Action<int>>();
        ...
        public void Watch(Action<int> onDataChanged)
        {
